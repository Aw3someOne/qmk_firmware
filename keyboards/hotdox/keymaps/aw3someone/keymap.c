 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  | C-Ins|           | S-Ins|   Y  |   U  |   I  |   O  |   P  |   \|   |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | -_     |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L2|   '"   |
 * |--------+------+------+------+------+------|  [{  |           |  }]  |------+------+------+------+------+--------|
 * | (/Shift|Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl| )/Shift|
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 * | Ctrl   | LGui | LAlt |AltShf| ~L1  |                                       | Left | Down | Up   | Right| ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | C-c  | C-v  |       | C-z  | C-y    |
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
 *                                 | Space|Del   |------|       |------|Backspac|Enter |
 *                                 |      |      | End  |       | PgDn |        |      |
 *                                 `--------------------'       `----------------------'
 */
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_TAB,         KC_Q,         KC_W,   KC_E,   KC_R,    KC_T,   LSFT(KC_INS),
        KC_MINS,        KC_A,         KC_S,   KC_D,   KC_F,    KC_G,
        KC_LSPO,        CTL_T(KC_Z),  KC_X,   KC_C,   KC_V,    KC_B,   KC_LBRC,
        KC_LCTL,        KC_LGUI,      KC_LALT,LALT(KC_LSFT),   TT(SYMB),
                                              LCTL(KC_C),      LCTL(KC_V),
                                                               KC_HOME,
                                               KC_SPC,KC_DEL , KC_END,
        // right hand
             KC_EQL,      KC_6,   KC_7,  KC_8,   KC_9,   KC_0,             KC_MINS,
             LSFT(KC_INS),  KC_Y,   KC_U,  KC_I,   KC_O,   KC_P,             KC_BSLS,
...
// MEDIA AND MOUSE
[MDIA] = LAYOUT_ergodox(
       RESET,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LCTL(KC_PSCR),
